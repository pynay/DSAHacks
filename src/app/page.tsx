    ...
    <main id="main-content" className="min-h-screen bg-white text-[#071a2b]">
      ...
      <header className="absolute inset-x-0 top-0 z-20">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8">
          ...
          <Link href="/login" className="inline-flex items-center gap-2 rounded-full bg-[#071a2b] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#123a54]">Open console <ArrowRight size={15} /></Link>
        </div>
      </header>
